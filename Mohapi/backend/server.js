...
// Add these lines to serve the React build files
app.use(express.static(path.join(__dirname, '../my-wings-caffe/build')));
...
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname, '../my-wings-caffe/build', 'index.html'));
});
